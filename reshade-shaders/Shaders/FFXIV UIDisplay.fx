...
technique FFXIV_UIDisplay_Top_Keep <
	ui_tooltip = "Stores the location of the UI.\n\nMust be at the very top of your shader active shader list to work.";
>
{
	pass
	{
...
technique FFXIV_UIDisplay_Bottom_Restore <
	ui_tooltip = "Restores all UI elements into focus.\n\nMust be placed at the very bottom of your active shader list to work.";
>
{
	pass
	{
